    ...
    <div className="relative -top-16 flex gap-x-16">
      <div>
        ...
        <div
          ...
          className={cn(
            "relative w-[20rem] h-[24rem] rounded-[45px] bg-no-repeat bg-center bg-cover",
        ...
        >
          <p className="absolute bottom-12 px-7 text-lg">
      ...
      <div>
        ...
        >
          <p className="absolute bottom-10 px-7 text-lg">
